...
import time, os, sys
# TODO: need to add the initialization code into this file, so on launch of the webapp the program connects to
#	the device, and buttons provide the input for running the main program. also should run main program on timer
...
def runAll(uart_service):
	...
	uart_service.write('r'.encode("utf-8"))
